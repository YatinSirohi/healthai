          ...
          <div className="relative backdrop-blur-sm border border-border p-6">
            ...
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold tracking-tight">
                <span className="text-primary" style={{ color: "LightSkyBlue" }}>Your</span>{" "}
            ...
            <div className="relative backdrop-blur-sm border border-border rounded-lg p-6">
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-bold">
                  PLAN: <span className="text-primary" style={{ color: "LightSkyBlue" }}>{currentPlan.name}</span>
                </h3>
              </div>
                        ...
                        >
                          <AccordionTrigger className="px-4 py-3 hover:no-underline hover:bg-primary/10 font-mono">
                            <div className="flex justify-between w-full items-center">
                              <span className="text-primary" style={{ color: "LightSkyBlue" }}>{exerciseDay.day}</span>
